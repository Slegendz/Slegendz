...
<h3 align="center">
🚀 Full Stack Developer | Data Engineer | AI Builder
</h3>

<p align="center">
I build scalable web applications, design data pipelines, and develop AI-powered solutions.<br>
Focused on solving real-world problems with modern technologies.
</p>

---

### 💼 What I Do
- 🧠 Build scalable **full stack applications** using MERN and Next.js  
- 📊 Design and work on **data engineering pipelines** with PySpark, Databricks, and Snowflake  
- 🤖 Develop **AI-powered applications** using LangChain and LLM-based workflows  
- ☁️ Work with **cloud & infrastructure tools** including AWS, Azure, and Terraform  
- 💾 Strong foundation in **Python, TypeScript, SQL, and PostgreSQL**  
...
- ☁️ Cloud & Infrastructure (AWS, Azure, Terraform)  
- 🤖 AI Applications (LangChain, Generative AI)  
- 🧠 Problem Solving (DSA)  
